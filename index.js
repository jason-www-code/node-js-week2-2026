...
const { handleUpload, handleNotFound } = require("./handlers/upload");
 ...
 *
 * @example
 *   process.env.UPLOAD_DIR = '/tmp/uploads';c
...
function getUploadConfig() {
  ...
  return {
    ...
    maxFileSize: Number(MAX_FILE_SIZE_MB) * 1024 * 1024,
    gymName: GYM_NAME,
  };
}
...
function router(req, res, config) {
  ...
  //   - router 只看 method + url、呼叫對應 handler0
  // formidable 錯誤處理要點：
